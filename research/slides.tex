...
\begin{frame}{A \,\textperiodcentered\, Recycled magic: pay per episode, not per program}
  \begin{itemize}
    ...
    \item Honest, measured boundary: for full records, harder compression degrades sharply with episode count --- the dispatcher (now \punch{four strategies}) prices exact-per-episode accordingly.
  \end{itemize}
