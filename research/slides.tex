...
\begin{frame}{A \,\textperiodcentered\, Not an IQP trick: any Clifford$+T$ circuit}
  \begin{itemize}
    ...
    \item Tested on circuits whose answer is known \emph{by construction} (hidden shift): up to \punch{96 qubits}, right answer in seconds --- at the live count, $\hat P(s)=0.98$--$1.00$.
