...
def _print_summary(synthetic: list[EvalRow], real_world: list[EvalRow]) -> None:
    ...
    print(
        ...
        "- MCR reordering dominates on structured MCR-family circuits; TOHPE adds\n"
        "  duplicate destruction on commuting blocks when present.\n"
        "- On transpiled arithmetic, chemistry Trotter, and factored workloads,\n"
        "  peephole already captures all T reductions; surface-code T layer is an\n"
        "  exception where TOHPE removes commuting-block duplicates.\n"
