...
- **$a_j$ (amplitude scale):** Carries a common nonnegative real weight outside
  the active coefficient array. Global phase is intentionally omitted because
  Clifft represents the state ray.
