...
that reorder operations to shorten active lifetimes, including the default
scheduling pass, rely on a structural model of active width described in
[Active-Width Scheduling](active-width.md).
