...
Each directory contains a `data.js` file (the full history as a JS array, easy to skim) and an `index.html` viewer generated by `benchmark-action/github-action-benchmark`. To view the chart locally:
