...
2x2 unitary sweeps preserves state rays and sampling results.
"""

import numpy as np
import pytest
from conftest import assert_same_state_ray, random_dense_clifford_t_circuit
...
def test_u3_single_gate_fusion() -> None:
    ...
    assert_same_state_ray(sv_opt, sv_ref, rtol=1e-10)
...
def test_u3_two_qubits_with_entanglement() -> None:
    ...
    assert_same_state_ray(sv_opt, sv_ref, rtol=1e-6)
