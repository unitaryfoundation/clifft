    ...
    passes = [
        ...
        },
        {
            ...
            "detail": (
                ...
                "untouched. "
                "A deterministic work budget limits execution and classification probes "
                "during search. The default is 16 executed operations and up to 256 "
                "classification probes per HIR operation, plus execution overshoot from "
                "finishing sweeps and replays. Graph construction and neutral sinking "
                "are outside those counters. A zero budget leaves the HIR unchanged. "
